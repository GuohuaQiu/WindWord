...
public class FailWordListAdapter extends BaseAdapter {
     ...
     * Constructor
     *
     * @param context The context where the View associated with this FailWordListAdapter is running
     */
    public FailWordListAdapter(Context context) {
...
//            Log.i("convertView","is not null");
    ...
    private void bindView(int position, View view) {
        if (mCursor != null) {
            ...
            v.setText("" + Util.getFormatDate(mCursor.getLong(1)));
