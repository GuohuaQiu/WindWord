...
public class HardWordListAdapter extends BaseAdapter {


    private LayoutInflater mInflater = null;

    private Cursor  mCursor = null;
    private final static int index_wd = 0;
    private final static int index_score = 1;
    private final static int index_count = 2;
    private final static int index_level = 3;
     ...
     */
    public HardWordListAdapter(Context context) {
    ...
    private void bindView(int position, View view) {
        if (mCursor != null) {
            ...
            v.setText("" + mCursor.getLong(index_count));
